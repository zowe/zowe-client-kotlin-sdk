...
interface FilesAPI : API {
   ...
   */
  suspend fun retrieveFileContent(params: RetrieveFileContentRequest): RetrieveFileContentResponse
   ...
   */
  suspend fun writeToFile(params: WriteToFileRequest): WriteToFileResponse
   ...
   */
  suspend fun createFile(params: CreateFileRequest): CreateFileResponse
   ...
   */
  suspend fun deleteFile(params: DeleteFileRequest): DeleteFileResponse
   ...
   */
  suspend fun copyFile(params: CopyFileRequest): CopyFileResponse
   ...
   */
  suspend fun moveFile(params: MoveFileRequest): MoveFileResponse
   ...
   */
  suspend fun changeFileMode(params: ChangeFileModeRequest): ChangeFileModeResponse
   ...
   */
  suspend fun changeFileOwner(params: ChangeFileOwnerRequest): ChangeFileOwnerResponse
   ...
   */
  suspend fun changeFileTag(params: ChangeFileTagRequest): ChangeFileTagResponse
   ...
   */
  suspend fun fileExtAttributesUtility(params: FileExtAttributesUtilityRequest): FileExtAttributesUtilityResponse
   ...
   */
  suspend fun getFileACL(params: GetFileACLRequest): GetFileACLResponse
   ...
   */
  suspend fun setFileACL(params: SetFileACLRequest): SetFileACLResponse
   ...
   */
  suspend fun linkFile(params: LinkFileRequest): LinkFileResponse
   ...
   */
  suspend fun unlinkFile(params: UnlinkFileRequest): UnlinkFileResponse
}
