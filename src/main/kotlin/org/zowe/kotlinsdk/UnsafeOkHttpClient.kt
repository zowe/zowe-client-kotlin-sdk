 ...
 */
@Deprecated(
  "Disables TLS certificate and host name validation. Use ZosmfOkHttpClient.getOkHttpClient(connection) instead. Scheduled for removal since v1.0.0. Decide on the respective changes to prevent security issues",
