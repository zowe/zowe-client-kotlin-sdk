...
open class ZosmfWriteToDatasetStatus(
  ...
  override val type: StatusType
    get() {
      return when {
        code == NoContent || code == Created -> StatusType.SUCCESS
