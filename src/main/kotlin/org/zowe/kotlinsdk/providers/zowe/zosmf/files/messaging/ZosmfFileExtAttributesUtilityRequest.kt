...
//
//  /** The request body to execute extattr function on a UNIX System Services file or directory */
//  @property:AvailableSince(ZVersion.ZOS_2_1) val fileExtAttributesRequestBody: ZosmfFileExtAttributesUtilityRequestBody,
//
...
//) : HttpRequest, FileExtAttributesUtilityRequest, ZosmfUtilitiesRequestHeaders {
//
...
//
//  override val body = fileExtAttributesRequestBody
//
//  override suspend fun produceHttpResponse(clientResponse: HttpResponse): org.zowe.kotlinsdk.providers.zowe.HttpResponse {
//    val response = clientResponse.body<ZosmfFileExtAttributesUtilityResponse>()
