...
class ZosmfChangeFileModeRequest(
  ...
  @property:AvailableSince(ZVersion.ZOS_2_1) val changeFileModeBody: ZosmfChangeFileModeRequestBody,
...
) : HttpRequest, ChangeFileModeRequest, ZosmfUtilitiesRequestHeaders {
  ...
  override suspend fun produceHttpResponse(clientResponse: HttpResponse): org.zowe.kotlinsdk.providers.zowe.HttpResponse {
    return ZosmfChangeFileModeResponse(clientResponse.status)
  }
