...
class ZosmfMigrateDatasetRequest(
  ...
  @property:AvailableSince(ZVersion.ZOS_2_1) val migrateDatasetBody: ZosmfMigrateDatasetRequestBody,
...
) : ZosmfDatasetUtilitiesRequest(), MigrateDatasetRequest, ZosmfDatasetUtilitiesRequestHeaders {

  override val fullDsPath = dsName

  override val body = migrateDatasetBody

  override suspend fun produceHttpResponse(clientResponse: HttpResponse): org.zowe.kotlinsdk.providers.zowe.HttpResponse? {
    return ZosmfMigrateDatasetResponse(clientResponse.status)
  }
