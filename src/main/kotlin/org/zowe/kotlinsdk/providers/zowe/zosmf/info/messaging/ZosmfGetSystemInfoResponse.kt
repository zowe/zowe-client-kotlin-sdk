...
//  @property:AvailableSince(ZVersion.ZOS_2_1) val zosmfSafRealm: String? = null,
//
//  /** zosmf_port response param */
//  @SerialName("zosmf_port")
//  @property:AvailableSince(ZVersion.ZOS_2_1) val zosmfPort: String? = null,
//
//  /** zosmf_full_version response param */
//  @SerialName("zosmf_full_version")
//  @property:AvailableSince(ZVersion.ZOS_2_1) val zosmfFullVersion: String? = null,
//
//  /** plugins response param */
//  @SerialName("plugins")
//  @property:AvailableSince(ZVersion.ZOS_2_1) val plugins: List<ZosmfPlugin> = emptyList(),
//
//  /** api_version response param */
//  @SerialName("api_version")
//  @property:AvailableSince(ZVersion.ZOS_2_1) val apiVersion: String? = null,
//
//  /** zos_version response param */
//  @SerialName("zos_version")
//  @property:AvailableSince(ZVersion.ZOS_2_1) val zosVersion: String? = null,
//
//  /** zosmf_version response param */
//  @SerialName("zosmf_version")
//  @property:AvailableSince(ZVersion.ZOS_2_1) val zosmfVersion: String? = null,
//
//  /** zosmf_hostname response param */
//  @SerialName("zosmf_hostname")
//  @property:AvailableSince(ZVersion.ZOS_2_1) val zosmfHostname: String? = null
...
//    @property:AvailableSince(ZVersion.ZOS_2_1) val version: String? = null,
//
//    /** pluginStatus response param */
//    @SerialName("pluginStatus")
//    @property:AvailableSince(ZVersion.ZOS_2_1) val status: ZosmfPluginStatus? = null,
//
//    /** pluginDefaultName response param */
//    @SerialName("pluginDefaultName")
//    @property:AvailableSince(ZVersion.ZOS_2_1) val defaultName: String? = null
//  ) {
//
//    @Serializable
