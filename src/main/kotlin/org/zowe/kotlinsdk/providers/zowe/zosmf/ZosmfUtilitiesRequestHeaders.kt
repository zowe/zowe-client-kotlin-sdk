...
interface ZosmfUtilitiesRequestHeaders : ZosmfDsAndFilesCommonRequestHeaders, ZosmfTargetSystemRequestHeaders {
  ...
  @AvailableOnly(ZVersion.ZOS_2_4) override val sessionLimitWait: Int?
  @AvailableSince(ZVersion.ZOS_2_1) override val asyncThreshold: Int?
  @AvailableSince(ZVersion.ZOS_2_1) override val responseTimeout: Int?
  @AvailableSince(ZVersion.ZOS_2_5) override val requestAcctnum: String?
  @AvailableSince(ZVersion.ZOS_2_5) override val requestProc: String?
  @AvailableSince(ZVersion.ZOS_2_5) override val requestRegion: String?
  // ZosmfTargetSystemRequestHeaders
  @AvailableSince(ZVersion.ZOS_2_4) override val targetSystem: String?
  @AvailableSince(ZVersion.ZOS_2_4) override val targetSystemUser: String?
  @AvailableSince(ZVersion.ZOS_2_4) override val targetSystemPassword: String?
