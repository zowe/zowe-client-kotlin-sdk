...
class ZosmfGetFileACLRequest(
  ...
  /** The request body to execute getfacl function on a UNIX System Services file or directory */
  @property:AvailableSince(ZVersion.ZOS_2_1) val getFileAclBody: ZosmfGetFileACLRequestBody,
...
) : HttpRequest, GetFileACLRequest, ZosmfUtilitiesRequestHeaders {
  ...
  override suspend fun produceHttpResponse(clientResponse: HttpResponse): org.zowe.kotlinsdk.providers.zowe.HttpResponse? {
    val response = clientResponse.body<ZosmfGetFileACLResponse>()
