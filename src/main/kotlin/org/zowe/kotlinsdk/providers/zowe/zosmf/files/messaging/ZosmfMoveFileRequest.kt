...
//class ZosmfMoveFileRequest(
//  override val connection: HttpConnection,
//
//  /** file-path-name path param */
//  @property:AvailableSince(ZVersion.ZOS_2_1) override val filePath: String,
//
//  /** The request body to execute mv function on a UNIX System Services file or directory */
//  @property:AvailableSince(ZVersion.ZOS_2_1) val moveFileBody: ZosmfMoveFileRequestBody,
//
...
//) : HttpRequest, MoveFileRequest, ZosmfUtilitiesRequestHeaders {
//
...
//
//  override val body = moveFileBody
//
//  override val responseClass = ZosmfMoveFileResponse::class.java
//
//  override suspend fun execRequestAndProduceResponse(payload: HttpClient): ZosmfMoveFileResponse {
//    val status = execRequestAndReturnStatus(payload)
//    return ZosmfMoveFileResponse(status)
//  }
//
//}
