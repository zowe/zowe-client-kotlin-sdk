 ...
 * @property body the request body to execute mv function on a UNIX System Services file or directory
 */
class ZosmfMoveFileRequest(
  connection: HttpConnection,
  override val filePath: String,
  @property:AvailableSince(ZVersion.ZOS_2_1) override val body: ZosmfMoveFileRequestBody,
  headers: ZosmfUtilitiesRequestHeaders = ZosmfUtilitiesRequestHeaders(),
) : ZosmfUssUtilitiesRequest(connection, filePath, headers), MoveFileRequest {
  ...
  override suspend fun produceZosmfResponseObject(
    ...
    return ZosmfMoveFileResponse(ZosmfStatus(clientResponse.status, errorReport))
  }
}
