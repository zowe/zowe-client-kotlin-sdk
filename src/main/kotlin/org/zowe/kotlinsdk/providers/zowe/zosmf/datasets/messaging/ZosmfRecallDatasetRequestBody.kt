 ...
 * @property request indicates the function hrecall
 * @property wait if true then the function waits for completion of the request. If false the request is queued
 */
@Serializable
data class ZosmfRecallDatasetRequestBody(
  @SerialName("request")
  @EncodeDefault
  @property:AvailableSince(ZVersion.ZOS_2_1) val request: String = "hrecall",
