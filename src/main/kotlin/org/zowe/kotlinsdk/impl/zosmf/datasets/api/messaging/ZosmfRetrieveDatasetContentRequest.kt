...
/**
 * Use this operation to retrieve the contents of a sequential data set, or a member of a partitioned data set (PDS or PDSE)
...
) : RetrieveDatasetContentRequest(dsName) {
