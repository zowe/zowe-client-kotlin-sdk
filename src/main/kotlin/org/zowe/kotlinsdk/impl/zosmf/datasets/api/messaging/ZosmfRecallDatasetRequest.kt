...
/**
 * Use this operation to recall migrated dataset
...
class ZosmfRecallDatasetRequest(
  ...
  /** The request body to recall migrated dataset */
  @AvailableSince(ZVersion.ZOS_2_1) val recallDatasetBody: ZosmfRecallDatasetBody,
