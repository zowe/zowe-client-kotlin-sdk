...
import org.zowe.kotlinsdk.core.files.api.messaging.CopyFileFromDatasetRequest
import org.zowe.kotlinsdk.impl.zosmf.files.data.XIBMBPXKAutoCvt
import java.nio.charset.Charset

/**
 * Use this operation to execute cp from dataset function on a UNIX System Services file or directory
 * @see <a href="https://www.ibm.com/docs/en/zos/3.1.0?topic=interface-zos-unix-file-utilities">z/OS UNIX file utilities</a>
 * */
class ZosmfCopyFileFromDatasetRequest(
  ...
  @AvailableSince(ZVersion.ZOS_2_1) val copyFileFromDatasetBody: ZosmfCopyFileFromDatasetBody,
...
) : CopyFileFromDatasetRequest(fpName) {
  ...
  override val body = copyFileFromDatasetBody
}
