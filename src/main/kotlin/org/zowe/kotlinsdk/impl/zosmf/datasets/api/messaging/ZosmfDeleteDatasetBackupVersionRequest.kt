...
/**
 * Use this operation to delete dataset backup version
...
class ZosmfDeleteDatasetBackupVersionRequest(
  ...
  /** The request body to delete dataset backup version */
  @AvailableSince(ZVersion.ZOS_2_1) val deleteDatasetBackupVersionBody: ZosmfDeleteDatasetBackupVersionBody,
...
) : DeleteDatasetBackupVersionRequest(dsName) {
