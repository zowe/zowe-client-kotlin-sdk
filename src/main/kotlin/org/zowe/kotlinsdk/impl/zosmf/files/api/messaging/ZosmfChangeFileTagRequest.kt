...
/**
 * Use this operation to execute chtag function on a UNIX System Services file or directory
 * @see <a href="https://www.ibm.com/docs/en/zos/3.1.0?topic=interface-zos-unix-file-utilities">z/OS UNIX file utilities</a>
 * */
class ZosmfChangeFileTagRequest(
  /** file-path-name path param */
  @AvailableSince(ZVersion.ZOS_2_1) override val fpName: String,

  /** The request body to execute chtag function on a UNIX System Services file or directory */
  @AvailableSince(ZVersion.ZOS_2_1) val changeFileTagBody: ZosmfChangeFileTagBody,
  ...
  override val body = changeFileTagBody
}
