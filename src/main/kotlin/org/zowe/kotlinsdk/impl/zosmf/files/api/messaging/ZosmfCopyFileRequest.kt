...
/**
 * Use this operation to execute cp function on a UNIX System Services file or directory
...
class ZosmfCopyFileRequest(
  ...
  /** The request body to execute cp function on a UNIX System Services file or directory */
  @AvailableSince(ZVersion.ZOS_2_1) val copyFileBody: ZosmfCopyFileBody,
  ...
  override val body = copyFileBody
}
