...
/**
 * Use this operation to execute chown function on a UNIX System Services file or directory
...
class ZosmfChangeFileOwnerRequest(
  ...
  /** The request body to execute chown function on a UNIX System Services file or directory */
  @AvailableSince(ZVersion.ZOS_2_1) val changeFileOwnerBody: ZosmfChangeFileOwnerBody,
  ...
  override val body = changeFileOwnerBody
}
