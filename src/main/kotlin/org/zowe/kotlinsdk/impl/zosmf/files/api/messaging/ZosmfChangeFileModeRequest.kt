...
/**
 * Use this operation to execute chmod function on a UNIX System Services file or directory
...
class ZosmfChangeFileModeRequest(
  ...
  /** The request body to execute chmod function on a UNIX System Services file or directory  */
  @AvailableSince(ZVersion.ZOS_2_1) val changeFileModeBody: ZosmfChangeFileModeBody,
  ...
  override val body = changeFileModeBody
}
