...
import org.zowe.kotlinsdk.core.files.api.messaging.ExtendedAttributesRequest
import org.zowe.kotlinsdk.impl.zosmf.files.data.XIBMBPXKAutoCvt
import java.nio.charset.Charset

/**
 * Use this operation to execute extattr function on a UNIX System Services file
 * @see <a href="https://www.ibm.com/docs/en/zos/3.1.0?topic=interface-zos-unix-file-utilities">z/OS UNIX file utilities</a>
 * */
class ZosmfExtendedAttributesRequest(
  /** file-path-name path param */
  @AvailableSince(ZVersion.ZOS_2_1) override val fpName: String,

  /** The request body to execute extattr function on a UNIX System Services file */
  @AvailableSince(ZVersion.ZOS_2_1) val extendedAttributesBody: ZosmfExtendedAttributesBody,
  ...
  @AvailableSince(ZVersion.ZOS_2_1) val xIBMBPXKAutoCvt: XIBMBPXKAutoCvt? = null,
...
) : ExtendedAttributesRequest(fpName) {
  ...
  override val body = extendedAttributesBody
}
