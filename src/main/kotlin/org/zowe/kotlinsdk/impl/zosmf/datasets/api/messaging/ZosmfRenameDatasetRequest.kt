...
/**
 * You can use this operation to rename dataset or dataset member
...
class ZosmfRenameDatasetRequest(
  ...
  @AvailableSince(ZVersion.ZOS_2_1) val renameDatasetBody: ZosmfRenameDatasetBody,
